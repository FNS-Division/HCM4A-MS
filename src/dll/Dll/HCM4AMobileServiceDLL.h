...
#include "HCM4AMobileServiceMain.h"



void HCM4AMobileServiceDLL2(int I_C_mode, int I_bor_dis, double I_PD,
    ...
    std::string pathToDebug2 = "c:\\Programs\\upp\\out\\MyApps\\CLANGx64.Debug.Debug_Full.Gui\\debug\\InDll.TXT";
    std::ofstream debugFile2(pathToDebug2);
    ...
    bool DEBUG = false;
    std::string pathToDebug = trim(I_str.substr(731)) + "\\DEBUG.TXT";
    ...
    if (DEBUG) {
        ...
        if (param.HCM_error != 0) {
            ...
            debugFile << "   Power in direction of Rx       : " << param.Power_to_Rx << " dBW\n";
...
//        
//                    //std::string pathToProfile = pathToDebug + "c:
//            std::string pathToProfile = "с:\\Programs\\upp\\out\\MyApps\\CLANGx64.Debug.Debug_Full.Gui\\debug\\Profile.TXT";
//            
//    		std::fstream profileFile(pathToProfile);
//    		profileFile.open(pathToProfile, std::ios::out);
//            if (profileFile.is_open()) {
//                profileFile << "\n Number of profile points  " << param.PN << "\n";
//                profileFile << " profile sampling distance " << param.PD << " km\n\n";
//                for (int i = 0; i < param.PN; i++) {
//                    profileFile << i << "\t" << param.T_Prof[i] << "\n" ;
//                }
//            }
//            profileFile.close();
